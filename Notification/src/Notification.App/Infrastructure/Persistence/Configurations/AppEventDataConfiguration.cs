    ...
    public class AppEventDataConfiguration : IEntityTypeConfiguration<AppEventData>
    {
        public void Configure(EntityTypeBuilder<AppEventData> builder)
        {
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<int>(builder.Property(an => an.Id).ValueGeneratedOnAdd(), "int(11)");

            RelationalPropertyBuilderExtensions
                .HasColumnName<int>(builder.Property(an => an.NotificationEventId).IsRequired(), "notification_event_id")
                .HasColumnType("int(11)")
                .HasDefaultValue(0);

            RelationalPropertyBuilderExtensions
                .HasColumnName<string>(builder.Property(an => an.ReferenceUniqueId).HasMaxLength(100), "reference_unique_id")
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnName<string>(builder.Property(an => an.AttachmentInfo).HasMaxLength(100), "attachment_info")
                .HasColumnType("varchar(100)")
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnName<string>(builder.Property(an => an.Url).HasMaxLength(255), "url")
                .HasColumnType("varchar(255)")
                .HasDefaultValue(null);

            RelationalPropertyBuilderExtensions
                .HasColumnName<string>(builder.Property(an => an.Path).HasMaxLength(255), "path")
                .HasColumnType("varchar(255)")
                .HasDefaultValue(null);
