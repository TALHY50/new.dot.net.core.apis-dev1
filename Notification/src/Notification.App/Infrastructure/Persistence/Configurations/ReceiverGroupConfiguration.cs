    ...
    public class ReceiverGroupConfiguration : IEntityTypeConfiguration<ReceiverGroup>
    {
        public void Configure(EntityTypeBuilder<ReceiverGroup> builder)
        {
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<int>(builder.Property(rg => rg.Id).ValueGeneratedOnAdd(), "int(11)");

            RelationalPropertyBuilderExtensions
                .HasColumnType<NotificationType>(builder.Property(rg => rg.Type).IsRequired(), "tinyint(4)")
                .HasConversion(
                    nt => nt.Type,
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<string>(builder.Property(rg => rg.Name).IsRequired().HasMaxLength(50), "0")
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(rg => rg.CreatedById).IsRequired(), 0)
                .HasColumnName("created_by_id")
                .HasColumnType("int(11)");

            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(rg => rg.UpdatedById).IsRequired(), 0)
                .HasColumnName("updated_by_id")
                .HasColumnType("int(11)");

            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(rg => rg.Status).IsRequired(), 1)
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(rg => rg.CompanyId).IsRequired(), 0)
