 ...
 public class EmailOutgoingConfiguration : IEntityTypeConfiguration<EmailOutgoing>
    {
        public void Configure(EntityTypeBuilder<EmailOutgoing> builder)
        {
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<int>(builder.Property(neo => neo.Id).ValueGeneratedOnAdd(), "int(11)");

            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(neo => neo.NotificationCredentialId).IsRequired(), 0)
                .HasColumnName("notification_credential_id")
                .HasColumnType("int(11)");

            RelationalPropertyBuilderExtensions
                .HasDefaultValue<string>(builder.Property(neo => neo.Subject).IsRequired().HasMaxLength(255), "0")
                .HasColumnType("varchar(255)")
                .HasComment("Subject of the email");

            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(neo => neo.Content).IsRequired(), "longtext")
                .HasComment("full email body content with html");

            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(neo => neo.To).IsRequired(), "mediumtext")
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<bool>(builder.Property(neo => neo.IsAttachment).IsRequired(), false)
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(neo => neo.Status).IsRequired(), 0)
                .HasColumnType("tinyint(4)")
                .HasComment("0=pending, 1= completed, 2= failed");

            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(neo => neo.Attempt).IsRequired(), 0)
                .HasColumnType("int(11)");
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnName<int>(builder.Property(neo => neo.NotificationEventId).IsRequired(), "notification_event_id")
                .HasColumnType("int(11)");

            RelationalPropertyBuilderExtensions
                .HasColumnName<string>(builder.Property(neo => neo.NotificationEventName).IsRequired().HasMaxLength(50), "notification_event_name")
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<int>(builder.Property(neo => neo.CompanyId).IsRequired(), 0)
