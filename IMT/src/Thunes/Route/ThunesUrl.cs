namespace Thunes.Route
{
    public class ThunesUrl
    {
        ...
        public const string CreateTransactionFromQuotationExternalIdUrl = "/v2/money-transfer/quotations/ext-{invoice_id}/transactions";
        public const string CreateAttachmentToTransactionByIdUrl = "/v2/money-transfer/transactions/{id}/attachments";
        public const string CreateAttachmentToTransactionByExternalIdUrl = "/v2/money-transfer/transactions/ext-{invoice_id}/attachments";
        public const string ConfirmTransactionByIdUrl = "/v2/money-transfer/transactions/{id}/confirm";
        public const string ConfirmTransactionByExternalIdUrl = "/v2/money-transfer/transactions/ext-{invoice_id}/confirm";
        public const string RetrieveTransactionInformationByTransactionIdUrl = "/v2/money-transfer/transactions/{id}";
        public const string RetrieveTransactionInformationByExternalIdUrl = "/v2/money-transfer/transactions/ext-{invoice_id}";
        public const string ListAttachmentsOfATransactionByIdUrl = "/v2/money-transfer/transactions/{id}/attachments";
        public const string ListAttachmentsOfTransactionByExternalIdUrl = "/v2/money-transfer/transactions/ext-{invoice_id}/attachments";
        public const string CancelTransactionByIdUrl = "/v2/money-transfer/transactions/{id}/cancel";
        public const string CancelTransactionByExternalIdUrl = "/v2/money-transfer/transactions/{invoice_id}/cancel";
        public const string RetrieveAQuotationByIdUrl = "/v2/money-transfer/quotations/{id}";
        public const string RetrieveQuotationByExternalIdUrl = "/v2/money-transfer/quotations/ext-{invoice_id}";
