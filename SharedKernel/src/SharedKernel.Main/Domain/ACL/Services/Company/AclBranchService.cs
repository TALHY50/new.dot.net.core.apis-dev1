...
namespace SharedKernel.Main.Domain.ACL.Services.Company
{
    ...
    public class AclBranchService : AclBranchRepository, IAclBranchService
    {
        ...
        /// <inheritdoc/>
        public AclBranchService(AclApplicationDbContext dbContext, IAclBranchRepository repository, IHttpContextAccessor httpContextAccessor) : base(dbContext, httpContextAccessor)
        {
