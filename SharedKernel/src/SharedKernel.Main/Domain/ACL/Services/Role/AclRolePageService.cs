...
namespace SharedKernel.Main.Domain.ACL.Services.Role
{
    public class AclRolePageService : AclRolePageRepository, IAclRolePageService
    {
        ...
        /// <inheritdoc/>
        public new AclApplicationDbContext Context { get; }
        ...
        /// <inheritdoc/>
        public AclRolePageService(AclApplicationDbContext dbContext, IAclUserRepository aclUserRepository, IHttpContextAccessor httpContextAccessor, IAclRoleRepository aclRoleRepository, IAclPageRepository aclPageRepository) : base(dbContext, aclUserRepository, httpContextAccessor, aclRoleRepository, aclPageRepository)
        {
