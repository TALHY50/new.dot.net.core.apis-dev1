namespace SharedKernel.Main.Presentation.Routes
{
    public class Routes
    {
        ...
        public const string GetBusinessHourAndWeekendUrl = "business-hour-and-weekend";
        public const string GetBusinessHourAndWeekendByIdName = "get_business_hour_and_weekend_by_id";
        public const string GetBusinessHourAndWeekendByIdUrl = "business-hour-and-weekend/{id}";
        public const string CreateBusinessHourAndWeekendName = "create_business_hour_and_weekend";
        public const string CreateBusinessHourAndWeekendUrl = "business-hour-and-weekend";
        public const string DeleteBusinessHourAndWeekendName = "delete_business_hour_and_weekend";
        public const string DeleteBusinessHourAndWeekendUrl = "business-hour-and-weekend/{id}";
        public const string UpdateBusinessHourAndWeekendName = "update_business_hour_and_weekend";
        public const string UpdateBusinessHourAndWeekendUrl = "business-hour-and-weekend";


        // holiday settings
        public const string GetHolidaySettingName = "get_holiday_setting";
        public const string GetHolidaySettingUrl = "holiday-settings";
        public const string GetHolidaySettingByIdName = "get_holiday_setting_by_id";
        public const string GetHolidaySettingByIdUrl = "holiday-settings/{id}";
        public const string CreateHolidaySettingName = "create_holiday_setting";
        public const string CreateHolidaySettingUrl = "holiday-settings";
        public const string DeleteHolidaySettingName = "delete_holiday_setting";
        public const string DeleteHolidaySettingUrl = "holiday-settings/{id}";
        public const string UpdateHolidaySettingName = "update_holiday_setting";
        public const string UpdateHolidaySettingUrl = "holiday-settings";
        ...
        public const string GetCurrencyUrl = "Currency";
        public const string GetCurrencyByIdName = "get-currency-by-id";
        public const string GetCurrencyByIdUrl = "Currency/{id}";
        public const string CreateCurrencyName = "create-currency";
        public const string CreateCurrencyUrl = "Currency";
        public const string DeleteCurrencyName = "delete-currency";
        public const string DeleteCurrencyUrl = "Currency/{id}";
        ...
        public const string GetMttPaymentSpeedUrl = "mtt_payment_speed";
        public const string GetMttPaymentSpeedByIdName = "get_mtt_payment_speed_by_id";
        public const string GetMttPaymentSpeedByIdUrl = "mtt_payment_speed/{id}";
        public const string CreateMttPaymentSpeedName = "create_mtt_payment_speed";
        public const string CreateMttPaymentSpeedUrl = "mtt_payment_speed";
        public const string DeleteMttPaymentSpeedName = "delete_mtt_payment_speed";
        public const string DeleteMttPaymentSpeedUrl = "mtt_payment_speed/{id}";
        ...
        public const string GetTransactionLimitUrl = "transactionlimits";
        public const string FindTransactionLimitByIdName = "transaction_limit_by_id";
        public const string FindTransactionLimitByIdUrl = "transactionlimits/{id}";
        public const string CreateTransactionLimitName = "create_transaction_limit";
        public const string CreateTransactionLimitUrl = "transactionlimits";
        public const string UpdateTransactionLimitName = "update_transaction_limit";
        public const string UpdateTransactionLimitUrl = "transactionlimits/{id}";
        public const string DeleteTransactionLimitName = "delete_transaction_limit";
        public const string DeleteTransactionLimitUrl = "transactionlimits/{id}";
