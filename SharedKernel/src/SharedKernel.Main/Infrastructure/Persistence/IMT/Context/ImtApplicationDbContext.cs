           ...
           : DbContext(options), IApplicationDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Quotation>(entity =>
            {
                ...
                entity.Property(e => e.ImtDestinationCurrencyId).HasColumnName("imt_destination_currency_id");
                entity.Property(e => e.ImtProviderId).HasColumnName("imt_provider_id");
                entity.Property(e => e.ImtProviderServiceId).HasColumnName("imt_provider_service_id");
                entity.Property(e => e.ImtSourceCountryId).HasColumnName("imt_source_country_id");
                entity.Property(e => e.ImtSourceCurrencyId).HasColumnName("imt_source_currency_id");
            ...
            modelBuilder.Entity<TransactionLimit>(entity =>
            {
                ...
                entity.Property(e => e.DailyTotalNumber).HasColumnName("daily_total_number");
                entity.Property(e => e.MonthlyTotalAmount)
                    .HasPrecision(16, 4)
                    .HasColumnName("monthly_total_amount");
                entity.Property(e => e.MonthlyTotalNumber).HasColumnName("monthly_total_number");
                entity.Property(e => e.TransactionType).HasColumnName("transaction_type");
                entity.Property(e => e.UpdatedAt)
                    .HasColumnType("datetime")
                    .HasColumnName("updated_at");
                entity.Property(e => e.UpdatedById).HasColumnName("updated_by_id");
                entity.Property(e => e.UserCategory).HasColumnName("user_category");
            });
