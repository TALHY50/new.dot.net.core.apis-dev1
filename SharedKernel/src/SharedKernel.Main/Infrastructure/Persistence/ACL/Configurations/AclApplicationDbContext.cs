...
using SharedKernel.Main.Infrastructure.Persistence.ACL.Migrations;

namespace SharedKernel.Main.Infrastructure.Persistence.ACL.Configurations;

public partial class AclApplicationDbContext : DbContext, IApplicationDbContext
{
    public AclApplicationDbContext()
    {
    }

    public AclApplicationDbContext(DbContextOptions<AclApplicationDbContext> options)
        : base(options)
    {
    }
