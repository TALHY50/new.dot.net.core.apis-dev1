    ...
    public class CredentialConfiguration : IEntityTypeConfiguration<Credential>
    {
        public void Configure(EntityTypeBuilder<Credential> builder)
        {
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<int>(builder.Property(nc => nc.Id)
                    .ValueGeneratedOnAdd(), "int(11)");

            RelationalPropertyBuilderExtensions
                .HasColumnType<NotificationType>(builder.Property(nc => nc.Type)
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(nc => nc.Title)
                    .IsRequired()
                    .HasMaxLength(50), "varchar(50)")
                .HasComment("Name of the credentials. e.g: Codex, Verimo etc.");

            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(nc => nc.Host)
                    .IsRequired()
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<string>(builder.Property(nc => nc.Username)
                    .IsRequired()
                    .HasMaxLength(255), "0")
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<string>(builder.Property(nc => nc.Password)
                    .IsRequired()
                    .HasMaxLength(255), "0")
                .HasColumnType("varchar(255)")
            ...
            RelationalPropertyBuilderExtensions
                .HasDefaultValue<string>(builder.Property(nc => nc.ApiKey)
                    .IsRequired()
                    .HasMaxLength(255), "0")
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(nc => nc.EncryptionType)
                    .HasMaxLength(255), "varchar(255)")
                .HasColumnName("encryption_type")
                .HasComment("email encryption type e.g tls, ssl, starttls etc");

            RelationalPropertyBuilderExtensions
                .HasColumnType<TransportDriverType>(builder.Property(nc => nc.TransportDriver)
                    .HasMaxLength(255), "varchar(255)")
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(nc => nc.FromAddress)
                    .HasMaxLength(255), "varchar(255)")
                .HasColumnName("from_address")
                .HasComment("email/phone/url may be placed here");

            RelationalPropertyBuilderExtensions
                .HasColumnType<string>(builder.Property(nc => nc.FromName)
                    .HasMaxLength(50), "varchar(50)")
                .HasColumnName("from_name")
                .HasComment("Title of from address.");

            RelationalPropertyBuilderExtensions
                .HasColumnType<int>(builder.Property(nc => nc.CreatedById)
                    .IsRequired(), "int(11)")
                .HasColumnName("created_by_id")
                .HasDefaultValue(0);

            RelationalPropertyBuilderExtensions
                .HasColumnType<int>(builder.Property(nc => nc.UpdatedById)
                    .IsRequired(), "int(11)")
            ...
            RelationalPropertyBuilderExtensions
                .HasColumnName<int>(builder.Property(nc => nc.CompanyId)
                    .IsRequired(), "company_id")
