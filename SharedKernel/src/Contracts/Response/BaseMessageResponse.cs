...
namespace SharedKernel.Contracts.Response
{
    public partial class BaseMessageResponse
    {
        ...
        public BaseMessageResponse(string model, string language = "en-US")
        {
            ...
            _resourceManager = new ResourceManager("SharedKernel.Resources."+language + _cultureInfo.Name, _assembly);
            localizationService = new LocalizationService("SharedKernel.Resources."+language, _assembly, language);
