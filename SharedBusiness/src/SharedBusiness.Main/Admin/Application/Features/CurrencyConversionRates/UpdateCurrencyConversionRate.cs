...
namespace SharedBusiness.Main.Admin.Application.Features.CurrencyConversionRates
{
    ...
    public class UpdateCurrencyConversionRateCommandHandler : CurrencyConversionRateBase, IRequestHandler<UpdateCurrencyConversionRateCommand, ErrorOr<CurrencyConversionRate>>
    {
        ...
        public async Task<ErrorOr<CurrencyConversionRate>> Handle(UpdateCurrencyConversionRateCommand command, CancellationToken cancellationToken)
        {
            ...
            {
                return Error.NotFound(description: "CurrencyConversionRate not found",
