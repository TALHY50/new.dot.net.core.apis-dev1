...
namespace SharedBusiness.Main.Admin.Application.Features.TransactionTypes
{
    ...
    public class UpdateTransactionTypeByIdCommandHandler : TransactionTypeBaseCommand, IRequestHandler<UpdateTransactionTypeByIdCommand, ErrorOr<TransactionType>>
    {
