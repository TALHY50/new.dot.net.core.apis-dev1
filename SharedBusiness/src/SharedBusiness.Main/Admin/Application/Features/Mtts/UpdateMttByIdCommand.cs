...
namespace Admin.App.Application.Features.Mtts
{
    ...
    StatusValues status)
        ...
        public class UpdateMttByIdCommandHandler : CountryBase, IRequestHandler<UpdateMttByIdCommand, ErrorOr<Mtt>>
        {
            private readonly IMTTRepository _repository;
            private readonly IGuardAgainstNullUpdate _guard;

            public UpdateMttByIdCommandHandler(IMTTRepository repository, IGuardAgainstNullUpdate guard)
            {
