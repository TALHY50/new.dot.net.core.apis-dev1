            ...
            modelBuilder.Entity<Bank>(entity =>
    {
        ...
        entity.Property(e => e.Url)
            ...
            /*modelBuilder.Entity<Country>(entity =>
            {
                ...
                entity.Property(e => e.id).HasColumnName("id");
                entity.Property(e => e.IsoCodeShort)
                    .HasMaxLength(100)
                    .HasColumnName("code");
                entity.Property(e => e.CreatedAt)
                    .HasColumnType("datetime")
            ...
            modelBuilder.Entity<QuotationInfo>(entity =>
            {
                entity.HasKey(e => e.Id).HasName("PRIMARY");

                entity.ToTable("imt_quotation_info");

                entity.Property(e => e.Id).HasColumnName("id");
                entity.Property(e => e.CommisionFixed)
                    .HasPrecision(16, 4)
            ...
            modelBuilder.Entity<QuotationRequest>(entity =>
            {
                ...
                entity.ToTable("imt_quotation_requests");
