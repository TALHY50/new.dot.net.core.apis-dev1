...
INSERT INTO `imt_countries` VALUES (1,'TUR','TUR','Turkish',NULL,NULL,1,NULL,NULL),(2,'string','string','string',1,1,1,'2024-08-30 04:56:49','2024-08-30 04:56:49');
...
CREATE TABLE `imt_holiday_settings` (
  ...
  `gmt` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'GMT offset in hours (e.g., +5, -3)',
...
CREATE TABLE `imt_mtt_payment_speeds` (
  ...
  `gmt` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'GMT offset (e.g., +5, -3)',
...
CREATE TABLE `imt_mtts` (
  ...
  `transaction_type_id` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- Dump completed on 2024-08-30 18:34:33
