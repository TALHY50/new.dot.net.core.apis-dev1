...
/*!40000 ALTER TABLE `acl_user_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `imt_cities` (
  ...
  `created_by_id` int unsigned DEFAULT NULL,
  `updated_by_id` int unsigned DEFAULT NULL,
  `status` tinyint DEFAULT '1' COMMENT '1=active, 0=inactive, 2=soft-deleted',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `imt_corridors` VALUES (2,0,0,0,0,0,1,1,2,'2024-08-29 11:18:54','2024-08-29 11:18:54');
...
--
-- Table structure for table `imt_institution_app_settings`
--

DROP TABLE IF EXISTS `imt_institution_app_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `imt_institution_app_settings` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `institution_id` int unsigned NOT NULL,
  `app_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `imt_institution_app_settings`
--

LOCK TABLES `imt_institution_app_settings` WRITE;
/*!40000 ALTER TABLE `imt_institution_app_settings` DISABLE KEYS */;
INSERT INTO `imt_institution_app_settings` VALUES (1,1,'sfsdfdfg','dgdgfdgh','dfgdfg','token',1,'2024-08-30 08:16:41','2024-08-30 08:16:41',NULL,1,1);
/*!40000 ALTER TABLE `imt_institution_app_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `imt_institution_funds` (
  ...
  `account_number` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT 'Account number for the wallet',
...
CREATE TABLE `imt_institutions` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'Name of the institution',
  `url` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'Url of the official site',
  `company_id` int unsigned DEFAULT '0',
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Type : Master, we onboard an institution, and perform transactions under it, like the merchants of a payment system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `imt_institutions` VALUES (1,'sfsdfdfg','dfgdfg',1,1,1,1,'2024-08-30 08:16:41','2024-08-30 08:16:41');
...
CREATE TABLE `imt_mtts` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Type : Master, transaction setup between providers and us, like POS of a payment system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `imt_mtts` VALUES (3,1,NULL,1,1,1,1.0000,1.0000,1.0000,1.0000,1.0000,1.0000,1,1,1,1,1,'2024-09-02 18:50:05','2024-09-02 18:50:05');
...
CREATE TABLE `imt_payers` (
  ...
  `corridor_id` int unsigned DEFAULT NULL,
  `internal_payer_id` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `fund_currency_id` int unsigned DEFAULT NULL,
  `increment` decimal(16,4) NOT NULL,
  `money_precision` tinyint unsigned NOT NULL,
  `service_method_id` int unsigned DEFAULT NULL,
  `transaction_type_ids` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT 'CSV of transaction_type_id values',
  ...
  `cot_fixed` decimal(16,4) NOT NULL,
  `fx_spread` decimal(16,4) NOT NULL,
  `payment_speed` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `company_id` int unsigned DEFAULT '0',
  `status` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '0=inactive, 1=active, 2=pending, 3=rejected ',
  `created_by_id` int unsigned DEFAULT NULL,
  `updated_by_id` int unsigned DEFAULT NULL,
...
-- Dump completed on 2024-09-02 20:41:50
