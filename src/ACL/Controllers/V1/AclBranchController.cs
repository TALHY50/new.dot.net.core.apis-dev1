...
namespace ACL.Controllers.V1
{
    ...
    public class AclBranchController : Controller
    {
        ...
        {
            return await _unitOfWork.AclBranchRepository.GetAll();
        }
        ...
        {
            return await _unitOfWork.AclBranchRepository.AddBranch(request);
        }
