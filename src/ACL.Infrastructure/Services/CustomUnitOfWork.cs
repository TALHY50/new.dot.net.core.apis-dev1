...
//            this._assembly = programAssembly;
//            base.SetAssembly(this._assembly);
//        }
...
//            base.SetAssembly(this._assembly);
//            base.SetLocalizationService(new LocalizationService("ACL.Resources.en-US", typeof(Program).Assembly, "en-US"));
//        }
...
//        {
//            get { return new AclCompanyRepository(base, Config); }
//        }
...
//        IUnitOfWork<ApplicationDbContext, CustomUnitOfWork> IUnitOfWork<ApplicationDbContext, CustomUnitOfWork>.UnitOfWork { get { return base; } set => this.unitOfWork = (IUnitOfWork<ApplicationDbContext, ICustomUnitOfWork>)base; }

//        IUnitOfWork<ApplicationDbContext, CustomUnitOfWork> ICustomUnitOfWork._baseUnitOfWork => base;
