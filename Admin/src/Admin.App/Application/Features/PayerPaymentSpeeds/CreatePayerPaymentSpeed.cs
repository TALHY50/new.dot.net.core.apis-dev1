...
namespace ADMIN.App.Application.Features.PayerPaymentSpeeds
{
    ...
    internal sealed class CreatePayerPaymentSpeedCommandHandler(ImtApplicationDbContext context) : IRequestHandler<CreatePayerPaymentSpeedCommand, ErrorOr<PayerPaymentSpeed>>
    {
