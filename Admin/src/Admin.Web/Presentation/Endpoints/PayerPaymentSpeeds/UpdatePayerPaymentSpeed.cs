...
{
    public class UpdatePayerPaymentSpeed : PayerPaymentSpeedBase
    {
        public UpdatePayerPaymentSpeed(ILogger<PayerPaymentSpeedBase> logger, ICurrentUser currentUser) : base(logger, currentUser)
        {
        }
