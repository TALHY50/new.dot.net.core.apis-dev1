...
{
    public class UpdateCurrencyByIdController : CurrencyBaseController
    {
        public UpdateCurrencyByIdController(ILogger<UpdateCurrencyByIdController> logger, ICurrentUser currentUser) : base(logger, currentUser)
        {
        }
