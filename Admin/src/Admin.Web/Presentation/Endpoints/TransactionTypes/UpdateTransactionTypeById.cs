...
{
    public class UpdateTransactionTypeById : TransactionTypeBase
    {
        public UpdateTransactionTypeById(ILogger<UpdateTransactionTypeById> logger, ICurrentUser currentUser) : base(logger, currentUser)
        {
        }
