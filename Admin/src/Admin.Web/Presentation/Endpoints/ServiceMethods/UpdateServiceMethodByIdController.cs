...
{
    public class UpdateServiceMethodByIdController : ServiceMethodBase
    {
        public UpdateServiceMethodByIdController(ILogger<UpdateServiceMethodByIdController> logger, ICurrentUser currentUser) : base(logger, currentUser)
        {
        }
