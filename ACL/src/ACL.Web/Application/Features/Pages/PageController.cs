...
namespace ACL.Web.Application.Features.Pages
{
    ...
    public class PageController : ControllerBase
    {
        ...
        public ApplicationResponse Create(AclPageRequest request)
        {
        ...
        public ApplicationResponse Edit(AclPageRequest request)
        {
        ...
        public ApplicationResponse AddPageRoute(AclPageRouteRequest request)
        {
        ...
        public ApplicationResponse EditPageRoute(uint id, AclPageRouteRequest request)
        {
        ...
        public ApplicationResponse DeletePageRoute(uint id)
        {
