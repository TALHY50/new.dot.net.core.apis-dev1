...
namespace ACL.Business.Infrastructure.Middlewares.Extensions
{
    public static class IdentityApiEndpointRouteBuilderExtensions
    {
        ...
        /// </param>
        /// <returns>An <see cref="IEndpointRouteBuilder"/> to further customize the added endpoints.</returns>
