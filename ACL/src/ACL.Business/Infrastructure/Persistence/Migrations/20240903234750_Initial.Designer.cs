...
namespace ACL.Business.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240903234750_Initial")]
            ...
            modelBuilder.Entity("ACL.Business.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "19",
                            Claims = "[{\"Type\":\"scope\",\"Value\":\"CanReadWeather\"}]",
                            CompanyId = 1,
                            Country = 0,
                            ...
                            LastName = "admin1",
                            OtpChannel = (sbyte)0,
                            Password = "QCy4DY93n7XSPqOJAjrq9hmwoIuaq9zqbDUBXmXPs+DgWlbGHBxWVQTlQVdmmUYUk0D21muGuNGQr32ro0zFdA==",
                            PermissionVersion = 1,
                            Phone = "+8801788343704",
                            RefreshToken = "{\"Value\":null,\"Active\":true,\"ExpirationDate\":\"9999-12-31T23:59:59.9999999\",\"Id\":0,\"DomainEvents\":[]}",
                            RememberToken = "",
