INSERT INTO acl.acl_branches (company_id,name,address,description,status,`sequence`,created_by_id,updated_by_id,created_at,updated_at) VALUES
...
INSERT INTO acl.acl_countries (company_id,name,description,code,status,`sequence`,created_by_id,updated_by_id,created_at,updated_at) VALUES
	 (0,'Bangladesh','This is beautiful country','bn',1,0,2,2,'2024-05-01 03:01:56.388105','2024-05-01 03:01:56.388288');
INSERT INTO acl.acl_modules (name,icon,`sequence`,display_name,created_at,updated_at) VALUES
...
INSERT INTO acl.acl_pages (module_id,sub_module_id,name,method_name,method_type,available_to_company,created_at,updated_at) VALUES
...
INSERT INTO acl.acl_role_pages (role_id,page_id,created_at,updated_at) VALUES
	 ...
	 (1,3083,NULL,NULL),
	 (1,3084,NULL,NULL);
INSERT INTO acl.acl_roles (title,name,status,company_id,created_by_id,updated_by_id,created_at,updated_at) VALUES
	 ('super-super-admin','',1,1,NULL,NULL,'2019-03-21 20:38:30','2015-11-09 07:17:00');
INSERT INTO acl.acl_states (company_id,country_id,name,description,status,`sequence`,created_by_id,updated_by_id,created_at,updated_at) VALUES
	 (1,1,'Florida','Florida is state of USA',1,100,2,2,'2024-05-01 03:02:07.804194','2024-05-01 03:02:07.804427');
INSERT INTO acl.acl_sub_modules (module_id,name,controller_name,icon,`sequence`,default_method,display_name,created_at,updated_at) VALUES
