...
namespace ACL.Bussiness.Infrastructure.Middlewares
{
    public class GlobalExceptionHandlerMiddleware
    {
        private readonly RequestDelegate _next;
        ACL.Bussiness.Contracts.Responses.BaseResponse aclResponse = new ACL.Bussiness.Contracts.Responses.BaseResponse();
